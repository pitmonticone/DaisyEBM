...
ebm_D1 <- function(cycles,S,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta){
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
ebm_D2 <- function(cycles,S,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta){
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
ebm_D3 <- function(cycles,S,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta){
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
server <- function(input, output,session) {
  ...
  output$plot1_Run1 <- renderPlot({
    data11 <- ebm11(100,300,input$A,input$B,input$K,input$ai,input$ab,input$gamma,input$delta)
  ...
  output$plot2_Run1 <- renderPlotly({
    TEMP1 <- ebm12(100,300,input$A,input$B,input$K,input$ai,input$ab,input$gamma,input$delta)
  ...
  output$plot1_noDaisy <- renderPlot({
   ...
   # data_ND1 <- ebm_ND1(500,input$S,input$w0,input$b0,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
    ...
    plot_ND1 <- ebm_ND1(500,input$S,input$w0,input$b0,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plot1_Daisy <- renderPlot({
    data_D1 <- ebm_D1(500,input$S,input$w0,input$b0,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plot2_Daisy <- renderPlot({
    data_D2 <- ebm_D2(500,input$S,input$w0,input$b0,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plot3_Daisy <- renderPlotly({
    ...
    TEMP <- ebm_D3(500,input$S,input$w0,input$b0,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
