...
ebm51 <- function(cycles1,cycles2,S,A,B,K,ai,ab,gamma,delta ) {
  ...
  TEMP5 <- matrix(NA, nrow=length(Zones), ncol=cycles1)
  a <- alb(T5,ai,ab,gamma,delta)
  Sarr <- rep(0,cycles1) 
  
  for(j in c(0:cycles1)){
    S5 <- Sun5(j)
    Rin <- S*Incident(S5,SunWt)
    for(i in c(1:cycles2))
    {Tcos <- cosZones*T5
    Tm <- sum(Tcos)/sum(cosZones)
...
ebm_D1 <- function(cycles,S,w0,b0,T0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta) {
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
ebm_D2 <- function(cycles,S,w0,b0,T0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta) {
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
ebm_D3 <- function(cycles,S,w0,b0,T0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta) {
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
ebm_Db <- function(cycles,S,w0,b0,T0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta) {
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
ebm_Dw <- function(cycles,S,w0,b0,T0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta) {
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
  Sun6 <- function(x){S*(1+0.1*cospi(x/180))}
  gauss <-  function(x,m,sd,b){
...
server <- function(input, output,session){
  ...
  output$plot1_Daisy <- renderPlot({
    data_D1 <- ebm_D1(500,input$S,input$w0,input$b0,input$T0,input$c,input$k,input$D,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plot2_Daisy <- renderPlot({
    data_D2 <- ebm_D2(500,input$S,input$w0,input$b0,input$T0,input$c,input$k,input$D,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plot3_Daisy <- renderPlotly({
    ...
    TEMP <- ebm_D3(500,input$S,input$w0,input$b0,input$T0,input$c,input$k,input$D,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plotb_Daisy <- renderPlotly({
    BLACK <- ebm_Db(500,input$S,input$w0,input$b0,input$T0,input$c,input$k,input$D,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
  ...
  output$plotw_Daisy <- renderPlotly({
    WHITE <- ebm_Dw(500,input$S,input$w0,input$b0,input$T0,input$c,input$k,input$D,input$A,input$B,input$K,input$ai,input$ab,input$aW,input$aB,input$gamma,input$delta)
