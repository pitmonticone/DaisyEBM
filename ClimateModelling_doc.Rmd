...
$$ S_1(t)= \frac{1370}{100}x \\ S_2(t)= 1370(\sin^2(x+90)) \\ S_3(t)= 1370\Big(1-\frac{1}{\sqrt{2\pi}}e^{-(x-50)^2/2}\Big) \\ S_4(t)=1370\Big(1-\frac{1}{3}\delta(t-50)\Big) \\ S_5(t)=\frac{1}{100}(|x-150|+25) \\ S_6(t)=1370\Big(1+\frac{1}{10} cos(x)\Big) $$
...
plot1 <- ggplot(data1) +
  ...
  scale_y_continuous(sec.axis = sec_axis(~./25,name = "a"))+xlab("Latitude")+ylab("Temperature")
plot1
