...
ebm_D1 <- function(cycles,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta){
Incident <- function(x,y){ x*y/4 }
Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }
Sun6 <- function(x){1370*(1+0.1*cospi(x/180))}
...
ebm_D2 <- function(cycles,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta){
Incident <- function(x,y){ x*y/4 }
Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }
Sun6 <- function(x){1370*(1+0.1*cospi(x/180))}
...
ebm_D3 <- function(cycles,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta){
Incident <- function(x,y){ x*y/4 }
Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
Sun6 <- function(x){1370*(1+0.1*cospi(x/180))}
...
# Run 0
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
data01 <- ebm01(300,A,B,K,ai,ab,gamma,delta)
data02 <-ebm02(300,A,B,K,ai,ab,gamma,delta)
...
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
# WITHOUT DAISIES
data_ND1 <- ebm_ND1(500,w0,b0,A,B,K,ai,ab,aW,aB,gamma,delta)
...
#WITH DAISIES
data_D1 <- ebm_D1(500,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta)
data_D2 <- ebm_D2(500,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta)
TEMP <- ebm_D3(500,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta)
BLACK <- ebm_Db(500,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta)
WHITE <- ebm_Dw(500,w0,b0,c,k,A,B,K,ai,ab,aW,aB,gamma,delta)
