...
ebm_Db1(500,1370/920,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta)%>% layout(title="Distribution of Black Daisies",
...
ebm_Dw1(500,1370/920,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta) %>% layout(title="Distribution of White Daisies",
                                               xaxis = list(title = "Latitude"),
                                               yaxis = list(title = "Solar Luminosity") )
