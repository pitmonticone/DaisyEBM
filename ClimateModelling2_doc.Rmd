...
ebm_Db <- function(cycles,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta){
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
  Sun6 <- function(x){1370*(1+0.1*cospi(x/180))}
...
ebm_Dw <- function(cycles,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta){
  Incident <- function(x,y){ x*y/4 }
  Func <-  function(x){ 0.7768699*cos(0.0164348*x)^2+0.4617747 }  
  Sun6 <- function(x){1370*(1+0.1*cospi(x/180))}
...
BLACK   <- ebm_Db(500,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta)
WHITE   <- ebm_Dw(500,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta)
