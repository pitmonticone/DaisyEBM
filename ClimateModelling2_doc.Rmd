...
SunWt <- Func(Zones)
Rin <- Incident(S,SunWt)
Sarr1 <- rep(0,length(Zones))
#Sarr[1] <- Sun7(S,s)
Tarr1 <- rep(0,length(Zones))
...
data_ND4 <- ebm_ND4(300,1370/920,A,B,K,ai,ab,gamma,delta)
...
data_D4 <- ebm_D4(2,300,1370/920,w0,b0,c,k,D,A,B,K,ai,ab,aW,aB,gamma,delta)
